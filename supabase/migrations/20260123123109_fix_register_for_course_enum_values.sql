/*
  # Fix register_for_course enum values

  1. Problem
    - Funktion verwendet ungueltige status-Werte: 'confirmed', 'pending', 'cancelled'
    - ENUM erlaubt nur: 'registered', 'waitlist'

  2. Loesung
    - Alle Status-Pruefungen auf gueltige ENUM-Werte anpassen
*/
