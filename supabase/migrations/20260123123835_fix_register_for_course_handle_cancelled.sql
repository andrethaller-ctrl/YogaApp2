/*
  # Fix register_for_course to handle cancelled registrations

  1. Problem
    - UNIQUE constraint (course_id, user_id) verhindert erneute Anmeldung nach Stornierung
    - Funktion muss stornierte Registrierungen reaktivieren

  2. Loesung
    - Pruefen ob bereits eine stornierte Registrierung existiert
    - Falls ja: Reaktivieren statt neu anlegen
*/
